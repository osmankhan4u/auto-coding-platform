...
partial class TerminologyDbContextModelSnapshot : ModelSnapshot
{
    protected override void BuildModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyAlias", b =>
        {
            b.Property<Guid>("Id")
                .HasColumnType("uuid")
                .HasColumnName("id");
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyCodeVersion", b =>
        {
            b.Property<Guid>("Id")
                .HasColumnType("uuid")
                .HasColumnName("id");
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyConcept", b =>
        {
            b.Property<Guid>("Id")
                .HasColumnType("uuid")
                .HasColumnName("id");
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyEmbedding", b =>
        {
            b.Property<Guid>("Id")
                .HasColumnType("uuid")
                .HasColumnName("id");
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyAlias", b =>
        {
            b.HasOne("Terminology.Api.Data.Entities.TerminologyConcept", "Concept")
                .WithMany("Aliases")
        ...
        modelBuilder.Entity("Terminology.Api.Data.Entities.TerminologyConcept", b =>
        {
            b.HasOne("Terminology.Api.Data.Entities.TerminologyCodeVersion", "CodeVersion")
                .WithMany("Concepts")
